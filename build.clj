...
(defn- pom-template [version]
  [[:description "A Zodiac extension for connecting to a database with next.jdbc"]
   [:url "https://github.com/brettatoms/zodiac-sql"]
   [:licenses
    [:license
     [:name "MIT License"]
   ...
   [:scm
    [:url "https://github.com/brettatoms/zodiac-sql"]
    [:connection "scm:git:https://github.com/brettatoms/zodiac-sql.git"]
    [:developerConnection "scm:git:ssh:git@github.com:brettatoms/zodiac-sql.git"]
    [:tag (str "v" version)]]])
